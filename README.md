...
<p align="center">
  <b>A curated repository of Data Structures & Algorithms solutions on LeetCode, optimized for performance, clarity, and time-space efficiency.</b>
</p>

[![LeetCode Profile](https://img.shields.io/badge/LeetCode-vivek--kumar--kandu-FFA116?style=for-the-badge&logo=leetcode&logoColor=white)](https://leetcode.com/u/vivek-kumar-kandu/)
[![GitHub Profile](https://img.shields.io/badge/GitHub-vivek--kumar--kandu-181717?style=for-the-badge&logo=github&logoColor=white)](https://github.com/vivek-kumar-kandu)
[![CI Status](https://img.shields.io/github/actions/workflow/status/vivek-kumar-kandu/LeetCode-Solution/ci.yml?branch=main&style=for-the-badge&label=CI%20Build)](https://github.com/vivek-kumar-kandu/LeetCode-Solution/actions)
[![Language C++](https://img.shields.io/badge/Language-C%2B%2B20-00599C?style=for-the-badge&logo=c%2B%2B&logoColor=white)](https://isocpp.org/)
[![Language C](https://img.shields.io/badge/Language-C17-A8B9CC?style=for-the-badge&logo=c&logoColor=white)](https://en.wikipedia.org/wiki/C_(programming_language))

<br/>

<a href="https://leetcode.com/u/vivek-kumar-kandu/">
  <img src="https://leetcard.jacoblin.cool/vivek-kumar-kandu?theme=dark&font=Karma&ext=heatmap" alt="LeetCode Stats Card" />
</a>
...
- [🧩 Problem Solutions Index](#-problem-solutions-index)
- [🏷️ Categorized by Topics](#-categorized-by-topics)
- [🛠️ Local Compilation & Testing](#️-local-compilation--testing)
- [🤖 Automated CI Workflow](#-automated-ci-workflow)
...
## 🛠️ Local Compilation & Testing

To compile and test any solution locally with `g++`:

```bash
# Compile a C++ solution
g++ -std=c++20 -Wall -O2 0015-3sum/0015-3sum.cpp -o solution

# Compile a C solution
gcc -std=c17 -Wall -O2 0001-two-sum/0001-two-sum.c -o solution
```
...
Every commit to `main` triggers our GitHub Actions pipeline:
- Validates syntax across all `*.c` and `*.cpp` solution files.
- Ensures all solutions compile cleanly against modern C++20 and C17 standards.
- Keeps repository quality verified and ready for showcase.
...
- 🌐 **LeetCode**: [@vivek-kumar-kandu](https://leetcode.com/u/vivek-kumar-kandu/)
- 💻 **GitHub**: [@vivek-kumar-kandu](https://github.com/vivek-kumar-kandu)

<div align="center">
  <sub>⭐ If you find these solutions helpful, please consider giving the repository a star! ⭐</sub>
</div>